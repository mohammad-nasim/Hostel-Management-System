    ...
    <div class="container">
        ...
        <ul class="nav">
            <li class="nav-item ml-auto ">
                <a class="nav-link  text-info" href="adminform.php">এডমিন হিসেবে লগইন করুন</a>
            </li>
            <li class="nav-item  ">
        ...
        <div class="middle mt-3">
             <hr>
            <h2 class="text-center"><strong class="text-success">রেজিস্টারড</strong> ইউজার হিসেবে লগইন করুন</h2>
            <hr>
            <div class="form-warp mt-5 pt-5 ">
                <div class="card ml-auto mr-auto bg-dark" style="width: 22rem;">
                    <div class="icon mt-3 ml-auto mr-auto">
                        <i class="fas fa-user-circle display-2 text-success"></i> 
                    </div>
                    <div class="card-body  ">
                        ...
                        <button type="submit" name="login" class="btn btn-success btn-block">লগইন করুন</button>
