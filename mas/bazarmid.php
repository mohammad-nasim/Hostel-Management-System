                ...
                <div class="body">
                    <div class= " ml-auto mr-auto mt-5" style="width: 30rem;">
                            <div class="card-body bg-dark d-block">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="bazarinput.php">
                                        <button class="btn btn-warning btn-block text-dark">বাজার লিখুন</button>
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="bazarview.php">
                                        <button class="btn btn-success btn-block text-light">বাজার তালিকা</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
